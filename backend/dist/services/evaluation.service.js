...
export const evaluateSubmission = async (submissionId) => {
    try {
        ...
        const questionAnswers = submission.questionAnswers;
        ...
        const consultationEvaluation = await callOpenAIForConsultation(submission.scenario.description, submission.scenario.modelAnswer, submission.consultationText);
...
const callOpenAIForQuestion = async (question, modelAnswer, userAnswer) => {
    const prompt = `
...
const callOpenAIForConsultation = async (scenario, modelAnswer, consultationText) => {
    const prompt = `
